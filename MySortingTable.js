 ...
 */
 class MySortingTable {
    ...
    getDefaultSortSvg() {
       this.g.path.d = 'M29.696,20.076c0.088,0.16,0.08,0.354-0.021,0.51L19.395,36.449c-0.091,0.139-0.241,0.224-0.407,0.229 c-0.004,0-0.008,0-0.015,0c-0.157,0-0.31-0.076-0.403-0.205L6.998,20.609c-0.11-0.15-0.127-0.354-0.041-0.521 c0.085-0.168,0.257-0.272,0.444-0.272h21.855C29.443,19.814,29.609,19.914,29.696,20.076z M7.401,16.865h21.855 c0.008,0,0.017,0,0.021,0c0.275,0,0.5-0.225,0.5-0.5c0-0.156-0.07-0.295-0.184-0.388L18.086,0.205 C17.989,0.072,17.821,0.002,17.668,0c-0.165,0.005-0.315,0.09-0.406,0.229L6.982,16.094c-0.101,0.152-0.105,0.35-0.021,0.512 C7.05,16.765,7.218,16.865,7.401,16.865z';
        return this.getSvgTemplate(this.defaultSortIconSize, '0 0 36.678 36.678', 'enable-background:new 0 0 36.678 36.678; margin-left: 1rem;', this.g);
    }
    getDescSortSvg() {
        this.g.path.d = 'M31.92,5.021l-14.584,22.5c-0.089,0.138-0.241,0.223-0.406,0.229c-0.004,0-0.009,0-0.014,0 c-0.16,0-0.312-0.076-0.404-0.205L0.096,5.044C-0.015,4.893-0.031,4.69,0.054,4.523C0.139,4.354,0.312,4.25,0.5,4.25h31 c0.183,0,0.352,0.1,0.438,0.261C32.026,4.67,32.019,4.867,31.92,5.021z';
        return this.getSvgTemplate(this.descSortIconSize, '0 0 31.999 32', 'enable-background:new 0 0 31.999 32; margin-left: 0.8rem;', this.g);
    }
    getAscSortSvg() {
        this.g.path.d = 'M31.92,5.021l-14.584,22.5c-0.089,0.138-0.241,0.223-0.406,0.229c-0.004,0-0.009,0-0.014,0 c-0.16,0-0.312-0.076-0.404-0.205L0.096,5.044C-0.015,4.893-0.031,4.69,0.054,4.523C0.139,4.354,0.312,4.25,0.5,4.25h31 c0.183,0,0.352,0.1,0.438,0.261C32.026,4.67,32.019,4.867,31.92,5.021z';
        return this.getSvgTemplate(this.descSortIconSize, '0 0 31.999 32', 'enable-background:new 0 0 31.999 32; margin-left: 0.8rem; margin-bottom: 5px; transform: rotate(180deg); ', this.g);
    }
